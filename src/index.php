                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="input-group align-items-center mb-3">
                                    ...
                                    <input type="text" id="last_mod" name="last_mod" class="form-control flatpickr"
                            ...
                            <div class="col-12 col-md-4">
                                <div class="input-group align-items-center mb-3">
                                    ...
                                    <select id="change_freq" name="change_freq" class="form-select">
                                        <option value="always" <?= $change_freq == 'always' ? 'selected' : '' ?>>always
                                        </option>
                                        <option value="hourly" <?= $change_freq == 'hourly' ? 'selected' : '' ?>>hourly
                                        </option>
                                        <option value="daily" <?= $change_freq == 'daily' ? 'selected' : '' ?>>daily
                                        </option>
                                        <option value="weekly" <?= $change_freq == 'weekly' ? 'selected' : '' ?>>weekly
                                        </option>
                                        <option value="monthly" <?= $change_freq == 'monthly' ? 'selected' : '' ?>>
                                            monthly
                                        </option>
                                        <option value="yearly" <?= $change_freq == 'yearly' ? 'selected' : '' ?>>yearly
                                        </option>
                                        <option value="never" <?= $change_freq == 'never' ? 'selected' : '' ?>>never
                                        </option>
                                    </select>
                                </div>
                            </div>
